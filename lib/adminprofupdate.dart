...
class AdminProfUpdatePage extends StatefulWidget {
  int _selectedIndex = 1;

  @override
  _AdminProfUpdatePageState createState() => _AdminProfUpdatePageState();
}

class _AdminProfUpdatePageState extends State<AdminProfUpdatePage> {
